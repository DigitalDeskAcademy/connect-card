...
// REMOVED: addServingOpportunitySkill and removeServingOpportunitySkill (Dec 2025)
// ServingOpportunitySkill model removed - shift scheduling moved to Planning Center
