/**
 * Platform Admin - Conversations Page
 *
 * Displays all conversations across all organizations for platform admins.
 * Future: Filter by organization, search across all conversations.
 */
