...
interface iAppProps {
  ...
  courseId?: string; // Keep for backwards compatibility
      ...
      try {
        ...
        const presignedResponse = await fetch("/api/s3/upload", {
          ...
          body: JSON.stringify({
            ...
            courseId: courseId, // Keep for backwards compatibility
            fileType: fileType,
            organizationSlug: organizationSlug, // New optional field
            courseName: courseName, // New optional field
          }),
        });
